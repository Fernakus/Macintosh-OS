...
# Instructions
echo "-------------------------------------------------------------------"
echo "Check that 'Install macOS High Sierra.app' is downloaded on the mac"
...
sudo -s /Applications/Install\ macOS\ High\ Sierra.app/Contents/Resources/createinstallmedia --volume /Volumes/e --applicationpath /Applications/Install\ macOS\ High\ Sierra.app
